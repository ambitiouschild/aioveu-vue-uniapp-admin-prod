<template>
  <view class="faq-container">
    <view class="wechat">
      <view class="tips">
        <text>长按关注「可我不敌可爱」公众号，获取交流群二维码。</text>
      </view>
      ...
      <view>
        ...
        <text :user-select="true" :selectable="true">ambitiouschild</text>
    ...
    <wd-collapse v-model="value">
      <wd-collapse-item title="开源项目issues" name="item1">
        <!-- #ifdef H5 -->
        <a href="https://gitee.com/ambitiouschild">#issues</a>
        <!-- #endif -->
        <!-- #ifdef MP-WEIXIN -->
        <text :user-select="true">https://gitee.com/ambitiouschild</text>
        <!-- #endif -->
      </wd-collapse-item>
